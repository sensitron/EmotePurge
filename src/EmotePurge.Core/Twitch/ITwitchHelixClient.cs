...
public interface ITwitchHelixClient
{
    ...
    // Surfaces each channel's broadcaster id alongside the login — needed to resolve their 7TV
    // identity without a second, name-based 7TV lookup.
    ...
    // GetModeratedChannelsAsync. true=subscribed, false=confirmed not subscribed (404),
