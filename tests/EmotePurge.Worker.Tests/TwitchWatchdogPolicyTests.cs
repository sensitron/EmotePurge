...
// Pure and clock-free — elapsed spans are passed in. The central case is the one the old
// chat-based staleness got wrong: a healthy connection whose channels are all silent (every
// broadcaster offline overnight) must never be forced to reconnect as long as Twitch's server
// PING keeps arriving.
