...
- [ ] **Touch-Targets:** ≥ 24 × 24 px für alles Interaktive (WCAG 2.5.8 AA), 44 px als Komfortziel für Primäraktionen. Ausnahme „equivalent target" (kleines Control in vollflächig klickbarer Karte, z. B. Emote-Checkbox) ist zulässig, wird aber **im Template als Kommentar dokumentiert**.
